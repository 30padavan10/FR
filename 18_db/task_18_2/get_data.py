...
def no_arg():
    ...
    print('-'*55)
    for row in result:
        print('{:18} {:15} {:8} {:15}'.format(*row))


if __name__ == '__main__':

    keys = ['mac', 'ip', 'vlan', 'interface', 'switch']
    conn = sqlite3.connect('/home/padavan/FR/18_db/task_18_1/dhcp_snooping.db')
    ...
    if len(argv) == 3:
        ...
        try:
            ...
            print('''Incorrect key. Key must:  '{}' '{}' '{}' '{}' '{}' '''.format(*keys))
    elif len(argv) == 1:
        no_arg()
    else:
